...
class TemperatureReadingsControllerTest < ActionController::TestCase
  ...
  test "should create temperature_reading" do
    assert_difference('TemperatureReading.count') do
      post :create, temperature_reading: { measuredAt: @temperature_reading.measuredAt, sensorID: @temperature_reading.sensorID, value: @temperature_reading.value }
    end
  ...
  test "should update temperature_reading" do
    patch :update, id: @temperature_reading, temperature_reading: { measuredAt: @temperature_reading.measuredAt, sensorID: @temperature_reading.sensorID, value: @temperature_reading.value }
    assert_redirected_to temperature_reading_path(assigns(:temperature_reading))
  end
